    ...
    <div className={css.wrapper}>
      <div className={css.heading}>
        <span className={css.secondaryText}>
          Location: <span className={css.red}>{data.name}</span>
        </span>
        <span className={css.text}>
          Type: <span className={css.green}>{data.type}</span>
        </span>
        <span className={css.text}>
          Dimension:<span className={css.red}>{data.dimension}</span>
        </span>
                ...
                <div className="max-w-sm">
                  ...
                  >
                    ...
                    {(() => {
                      if (data.status === "Dead") {
                        return (
                          <div className={`${css.badge} redColor `}>
                            {data.status}
                          </div>
                        );
                      } else if (data.status === "Alive") {
                        return (
                          <div className={`${css.badge} greenColor `}>
                            {data.status}
                          </div>
                        );
                      } else {
                        return (
                          <div className={` ${css.badge} greyColor `}>
                            {data.status}
                          </div>
                        );
                      }
